<div id="tab-registro" class="aba-content new-tab">
    <p>Para solicitar o Registro de Museus é simples. Basta seguir estes três passos:</p>

    <ul>
        <li>1. Preencher e assinar o Formulário de Solicitação de Registro, ao final da página.</li>
    ...
    <h6>Museu Público Federal</h6>
    <ul>
        <li>CPF e RG (autenticados em cartório) do responsável pelo museu;</li>
        <li>Documentação que comprove que o titular do RG e do CPF enviados é o responsável pelo museu, que poderá ser através de termo de posse, ato de nomeação, ou outro documento congênere;</li>
    ...
    <ul>
        <li>CPF e RG (autenticados em cartório) do responsável pelo museu;</li>
        <li>Documentação que comprove que o titular do RG e CPF enviados é o responsável pelo museu, que poderá ser através de termo de posse, ato de nomeação, ou outro documento congênere;</li>
        <li>CNPJ do museu ou da instituição mantenedora (com personalidade jurídica);</li>
        <li>Instrumento de criação do museu ou outro documento oficial da instituição à qual o museu esteja subordinado/vinculado;</li>
        <li>Termo de Solicitação do Registro preenchido.</li>
    </ul>
    ...
    <h5>ATENÇÃO!</h5>
    <ul>
        <li>As despesas de autenticação e envio deverão correr por conta do museu solicitante;</li>
        <li>O museu deverá manter atualizados todos os seus dados junto ao Registro de Museus, enviando toda a documentação comprobatória de qualquer alteração das informações já fornecidas;</li>
