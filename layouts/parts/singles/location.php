...
<?php if ( $this->isEditable() || (($has_private_location && $entity->publicLocation && $lat && $lng) || (!$has_private_location && $lat && $lng)) ): ?>
    ...
    <div class="servico clearfix">
        ...
        <div class="infos">
            ...
            <?php if($this->controller->id == 'space') :?>
                <p>
                    <span class="label"><?php \MapasCulturais\i::_e($_metadataSpace['mus_territorioCultural']->label); ?>:</span>
                    <span class="js-editable" data-edit="mus_territorioCultural" data-original-title="<?php \MapasCulturais\i::_e($_metadataSpace['mus_territorioCultural']->label); ?>" data-emptytext="Informe">
                        <?php echo $entity->mus_territorioCultural; ?>
                    </span>
                </p>
            <?php endif; ?>
